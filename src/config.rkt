...
(define all-flags
  #hash([precision . (double fallback)]
        ...
        [rules . (arithmetic polynomials fractions exponents trigonometry hyperbolic numerics special bools branches ruler)]))
...
(define default-flags
  #hash([precision . (double fallback)]
        ...
        [reduce . (regimes avg-error binary-search branch-expressions)]
        [rules . (arithmetic polynomials fractions exponents trigonometry hyperbolic special bools branches ruler)]))
...
(define *node-limit* (make-parameter 50000))
